...
public class TceMouvement : MonoBehaviour
{
    //ref d'autre script
    ...
    void Start() {
        ...
        postProcessLayer.enabled = isPausedTce;
    }

    //pour mettre en pause
    [Header("Prendre une pause sa fait du bien")]
    public GameObject pauseMenu;
    public bool isPausedTce = false;
