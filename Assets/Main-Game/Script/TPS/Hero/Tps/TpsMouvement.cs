...
public class TpsMouvement : MonoBehaviour
{
    //ref d'autre script
    ...
    void Start() {
        ...
        postProcessLayer.enabled = isPausedTps;
    }

    //pour mettre en pause
    [Header("Prendre une pause sa fait du bien")]
    public GameObject pauseMenu;
    public bool isPausedTps = false;
