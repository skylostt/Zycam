...
public class TntMouvement : MonoBehaviour
{
    //ref d'autre script
    ...
    void Start() {
        ...
        postProcessLayer.enabled = isPausedTnt;
    }

    //pour mettre en pause
    [Header("Prendre une pause sa fait du bien")]
    public GameObject pauseMenu;
    public bool isPausedTnt = false;
